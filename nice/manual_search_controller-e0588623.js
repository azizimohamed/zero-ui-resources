...
const BACKDROP_SEL = "[data-manual-search-backdrop]";
...
export default class extends Controller {
  ...
  refreshDomRefs() {
    if (this.backdropEl && document.body.contains(this.backdropEl)) {
      this.inputEl = this.backdropEl.querySelector("[data-manual-search-input]");
      this.contentEl = this.backdropEl.querySelector("[data-manual-search-content]");
      return;
    }
  ...
  async runFetch() {
    ...
    try {
      ...
      if (!response.ok) {
        this.contentEl.innerHTML = this.errorHtml();
        return;
      }
  ...
  errorHtml() {
    return `<div class="global-search-empty"><p class="global-search-empty-title">Search failed</p><p class="global-search-empty-hint">Try again in a moment.</p></div>`;
  }
}
